...
export default function GraveyardPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {item.options.map((opt: any) => (
                    <button
                      ...
                      className={`flex items-center justify-between p-4 border rounded-lg transition group text-left ${resolvingId === item._id
